...
import documentAnalysisGif from "../assets/document-analysis.gif";
      ...
      <div className="d-flex flex-wrap align-items-center gap-3">
        ...
        <div className="d-flex align-items-center gap-2">
          <div className="topbar__avatar">
            <img className='w-100 h-100 object-fit-cover' src={user?.userImage || defaultUserImg} alt="profile_img" />
          </div>
          <div>
        ...
        <div className="col-12 px-3 px-lg-4 content-section" style={{ paddingBlock: '10px', flexGrow: 1 }}>
          ...
          {active === "new" && (
            <div className="h-100 d-flex flex-column align-items-center justify-content-center new-report-section">
              <div className="mb-3">
                <img src={documentAnalysisGif} alt="document-analysis" width={150} />
              </div>
